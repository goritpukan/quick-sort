...
import { getArrayFromFile, writeArrayToFile } from './array.js';
...
await writeArrayToFile(arr1, 'default-quick-sort-result.json');
await writeArrayToFile(arr2, 'median-of-three-quick-sort-result.json');
await writeArrayToFile(arr3, '3-pivot-quick-sort-result.json');
